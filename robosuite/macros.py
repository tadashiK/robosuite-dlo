...
# Check if macros_private.py exists.
base_path = robosuite.__path__[0]
macros_private_path = os.path.join(base_path, "macros_private.py")

if os.path.exists(macros_private_path) and __file__ != macros_private_path:
    from robosuite.macros_private import *
else:
    # Modify the following variables in macros_private.py
